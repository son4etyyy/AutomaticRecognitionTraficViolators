...
CREATE TABLE permitted_vehicles (license_plate_number character varying(128), type character varying(128), PRIMARY KEY(license_plate_number));
ALTER TABLE permitted_vehicles OWNER TO alpralpr;" |sudo -u postgres psql
